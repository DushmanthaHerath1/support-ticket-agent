...
class Conversation(Base):
    ...
    # Live status for Dashboard / Manager queries
    status: Mapped[ConversationStatus] = mapped_column(
        String, nullable=False, default=ConversationStatus.OPEN
    )
...
class RefundApproval(Base):
    ...
    status: Mapped[RefundStatus] = mapped_column(
        String, nullable=False, default=RefundStatus.PENDING
    )
    decided_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)

    # Classification snapshot at proposal time for the reviewing manager
    category: Mapped[TicketCategory | None] = mapped_column(String, nullable=True)
    sentiment: Mapped[SentimentType | None] = mapped_column(String, nullable=True)
...
class Ticket(Base):
    ...
    category: Mapped[TicketCategory] = mapped_column(String, nullable=False)
    sentiment: Mapped[SentimentType] = mapped_column(String, nullable=False)
    resolution: Mapped[ResolutionType] = mapped_column(String, nullable=False)
